...
app.post('/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
    try {
        ...
        if (event.type === 'payment.succeeded') {
            ...
            const customer = payment.metadata;
            const amountRands = (payment.amount / 100).toFixed(2);

            console.log('✅ Payment successful! ID:', payment.id);
            console.log('Customer:', customer);
            console.log('Amount: R', amountRands);
                            ...
                            <div style="background: #f9f7f4; border: 1px solid #e8e0d0; padding: 28px; margin-bottom: 30px;">
                                ...
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr style="border-top: 1px solid #e8e0d0;">
                                        <td style="padding: 12px 0 6px 0; color: #777; font-size: 0.85rem;">Payment ID</td>
                                        <td style="padding: 12px 0 6px 0; color: #0A0A0A; font-size: 0.75rem; text-align: right;">${payment.id}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 6px 0; color: #0A0A0A; font-size: 1rem; font-weight: bold;">Total Paid</td>
